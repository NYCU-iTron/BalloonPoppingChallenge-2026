"""Private ActiveRocketPy oracle adapter and rocket fidelity report.
...
from BalloonPoppingGymEnv.tensorflight.rocket import (
    ACTUATOR_ORDER,
    ActuatorSpec,
    RocketRHSComponents,
...
def generate_rocket_fidelity_report(
    *,
    steps: int = 256,
    seed: int = 2031,
    time_table_step: float = 0.00125,
...
def main() -> None:
    ...
    report = generate_rocket_fidelity_report(
        steps=args.steps,
        seed=args.seed,
