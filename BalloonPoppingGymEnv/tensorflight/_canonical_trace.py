"""Record regression traces without modifying the official ActiveRocketPy env.
...
Record one short launch/control trace::
    ...
    python -m BalloonPoppingGymEnv.tensorflight._canonical_trace --case launch_control \
        --output .artifacts/tensorflight/launch_control.npz

Record the complete fixed corpus::

    python -m BalloonPoppingGymEnv.tensorflight._canonical_trace \
        --corpus-dir .artifacts/tensorflight/oracle
"""
