"""Fidelity gates for the competition-specific tensor rocket model."""
...
from BalloonPoppingGymEnv.tensorflight._rocket_oracle import (  # noqa: E402
    apply_canonical_actuator_command,
    build_scenario1_oracle,
    canonical_actuator_outputs,
    canonical_components,
    generate_rocket_fidelity_report,
    scenario1_actuator_specs,
)
from BalloonPoppingGymEnv.tensorflight.rocket import (  # noqa: E402
...
@pytest.fixture(scope="module")
def report():
    return generate_rocket_fidelity_report(steps=64, seed=2042)


def test_training_rhs_module_has_no_canonical_or_scipy_imports() -> None:
    path = Path("BalloonPoppingGymEnv/tensorflight/rocket.py")
...
def test_rhs_and_integrators_stay_on_cuda(oracle) -> None:
