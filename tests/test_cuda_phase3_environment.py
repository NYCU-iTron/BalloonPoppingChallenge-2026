"""Phase 3 gates for the online balloon world and full tensor environment."""
...
from experiments.cuda.phase2_rocket import ActuatorSpec, Scenario1ActuatorBank
from experiments.cuda.phase3_balloon import (
    Scenario1BalloonSampler,
    TensorBalloonWorld,
    sample_scenario1_balloon_parameters,
)
from experiments.cuda.phase3_effects import (
    LinearGustProfile,
    SensorEffectConfig,
    TensorSensorSuite,
)
...
TENSOR_MODULES = (
    ROOT / "experiments" / "cuda" / "phase3_balloon.py",
    ROOT / "experiments" / "cuda" / "phase3_effects.py",
    ROOT / "experiments" / "cuda" / "phase3_environment.py",
)
...
def test_phase3_online_world_stays_on_cuda() -> None:
